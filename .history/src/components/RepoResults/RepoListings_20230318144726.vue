<template>
  <main class="flex-auto bg-brand-gray-2 p-8 mt-12">
    <ol>
      ...
      <div class="flex flex-row flex-nowrap">
        ...
        <div class="flex items-center justify-center">
          <router-link <!-- @click.native="scrollToTop" -->
            v-if="previousPage" role="link" :to="{ name: 'Repos', query: { page:
            previousPage } }" class="mx-3 text-sm font-semibold
            text-brand-blue-1" > Previous
          </router-link>

          <router-link <!-- @click.native="scrollToTop" -->
            v-if="nextPage" role="link" :to="{ name: 'Repos', query: { page:
            nextPage } }" class="mx-3 text-sm font-semibold text-brand-blue-1" >
            Next
          </router-link>
        </div>
      </div>
